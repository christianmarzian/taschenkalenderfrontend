<template>
  ...
  <section class="section">
    <div class="content">
      ...
      <p>Din personliga omslagsdesign är skyddad av ett genomskinligt plastskydd som gör din almanacka tålig. Vid design av almanacka och anteckningsbok finns möjligheten att välja färg på spiralbindningen som håller ihop din design. Spiralen är tillverkad i metall och kommer i färgerna silver, guld och rosé-guld.</p>

...
export default {
  ...
  computed: {
    computedDesignerUrl() {
      return `${this.$config.designerurl}?format=${this.$getFacetCode(this.product.facetValues,'DIN-Format')}&covertype=${this.$getFacetCode(this.product.facetValues,'Cover')}`
    }
  },

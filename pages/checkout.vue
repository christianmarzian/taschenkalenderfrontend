        ...
        <div class="columns is-multiline">
          <div class="column is-full">
            <b-checkbox v-model="newsletter">
                Jag accepterar <a href="/personuppgifter">Epicals Privacy policy</a>. Jag samtycker till att Epical skickar information om produkter/tjänster via email. Jag kan avregistrera mig närsomhelst.
            </b-checkbox>
          </div>
          <div class="column is-full">
